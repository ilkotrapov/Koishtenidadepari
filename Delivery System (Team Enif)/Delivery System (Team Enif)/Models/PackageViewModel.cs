...
public class PackageViewModel
{
    ...
    [Range(0.01, 100000, ErrorMessage = "The Package Length must be a positive number more than 0.")]
    public decimal Length { get; set; } = 0;

    [DisplayName("Width (cm)")]
    [Required(ErrorMessage = "The Package Width field is required.")]
    [Range(0.01, 100000, ErrorMessage = "The Package Width must be a positive number more than 0.")]
    public decimal Width { get; set; } = 0;

    [DisplayName("Hight (cm)")]
    [Required(ErrorMessage = "The Package Hight field is required.")]
    [Range(0.01, 100000, ErrorMessage = "The Package Hight must be a positive number more than 0.")]
